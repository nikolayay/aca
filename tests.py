tests = {
    ...
    "programs/pi.asm": (
        lambda cpu: "".join([str(val) for val in cpu.MEM[-8:]])
    ...
    "programs/mat_mul_vec.asm": (
        lambda cpu: cpu.MEM[-10:]
        == [385, 935, 1485, 2035, 2585, 3135, 3685, 4235, 4785, 5335]
    ),
    "programs/vector_adds.asm": (
        lambda cpu: cpu.MEM[-30:]
        == [
            0,
            2,
            4,
    ...
    "programs/vector_adds_unrolled.asm": (
        lambda cpu: cpu.MEM[-30:]
        == [
            0,
            2,
    ...
    "programs/mat_mul.asm": (
        lambda cpu: cpu.MEM[-64:]
        == [
            1380,
            1416,
            1452,
